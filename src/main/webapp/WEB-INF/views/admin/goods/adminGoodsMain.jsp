...
function fn_enable_detail_search(r_search){
   ...
   search_condition=frm_goods_list.search_condition;
   ...
   if(r_search.value=='detail_search'){
      ...
      search_condition.disabled=false;
      t_search_word.disabled=false;
      btn_search.disabled=false;
   }else{

      search_condition.disabled=true;
...
function fn_detail_search(search_condition,t_search_word){
	   var search_condition = $("#search_condition").val();
	   var t_search_word = $("input[name=t_search_word]").val();
	   if(search_condition == "all"){
	      url : "${contextPath}/admin/goods/selectGoods.do";
	   } else {
	      url : "${contextPath}/admin/goods/selectGoods.do";
	   }
	}
   ...
   <form name="frm_goods_list" method="post">   
      <TABLE cellpadding="10" cellspacing="10"  >
         <TBODY>
            <TR >
               <TD>
                  <input type="radio" name="r_search_option"  value="curDate_search" onClick="fn_enable_detail_search(this)" checked/> 등록일로조회 &nbsp;&nbsp;&nbsp;
            ...
            <tr>
              <td>
               ...
               <input   type="button"  value="조회" name="btn_search" onClick="fn_detail_search(search_condition,t_search_word)" disabled/>
              </td>
            </tr>
            <tr>
              <td>
               조회 기간:<input  type="text"  size="4" value="${beginYear}" />년
