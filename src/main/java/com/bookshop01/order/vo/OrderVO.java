...
public class OrderVO {
	...
	public OrderVO (int order_seq_num,
            int order_id,
			String member_id,
		    int goods_id,
		    String orderer_name,
		    String goods_title,
		    int order_goods_qty,
		    int goods_sales_price,
		    String goods_fileName,
		    String receiver_name,
		    String receiver_hp1,
		    String receiver_hp2,
		    String receiver_hp3,
		    String receiver_tel1,
		    String receiver_tel2,
		    String receiver_tel3,
		    String delivery_address,
		    String delivery_method,
		    String delivery_message,
		    String gift_wrapping,
		    String pay_method,
		    String pay_orderer_hp_num,
            String card_com_name,
            String card_pay_month,
            String orderer_hp) {
