...
public class GoodsDAOImpl  implements GoodsDAO{
	...
	/*상품 검색 추가*/
	public ArrayList selectGoodsByGoodsSort(String goodsSort) throws DataAccessException{
		ArrayList list=(ArrayList)sqlSession.selectList("mapper.goods.selectGoodsByGoodsSort",goodsSort);
		 return list;
	}
